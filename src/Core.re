...
module BrowserRouter = {
  external browserRouter : ReasonReact.reactClass = "BrowserRouter" [@@bs.module "react-router"];
  let make children =>
...
module Route = {
  external route : ReasonReact.reactClass = "Route" [@@bs.module "react-router"];
  let make
...
module Link = {
  external navLink : ReasonReact.reactClass = "Link" [@@bs.module "react-router"];
...
module NavLink = {
  external navLink : ReasonReact.reactClass = "NavLink" [@@bs.module "react-router"];
  let make
      _to::(_to: string)
